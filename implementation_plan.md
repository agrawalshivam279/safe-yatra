...
- [ ] weather_model.py -- Input: precipitation_mm, wind_kmh, visibility_m. Output: normalized score 0-100.
      Formula: score = min(100, (precip/200)*60 + (wind/150)*25 + (1 - visibility/10000)*15)
- [ ] terrain_model.py -- Input: slope_degrees, water_proximity_m, altitude_m. Output: score 0-100.
